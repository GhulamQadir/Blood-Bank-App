...
function ABGroup(){
    ...
    return(
        ...
        <View style={styles.aGroupView}>
            <Image style={styles.aGroupImg} source={{uri: 'https://cdn.pixabay.com/photo/2017/08/22/11/55/blood-group-2668693_1280.png'}} />
            <Text style={styles.aGroupText}>Group AB can donate to other AB's, but cn receive from all others. It has both A and B antigens on red cells (but neither A nor B antibody in the plasma)</Text>
