...
function OGroup(){
    ...
    return(
        ...
        <View style={styles.aGroupView}>
            <Image style={styles.aGroupImg} source={{uri: 'https://www.seekpng.com/png/small/364-3648208_blood-group-0-rh-factor-positive-blood-a.png'}} />
            <Text style={styles.aGroupText}>Group O can donate red blood cells to anybody. It has neither A nor B antigens on red cells (but both A and B antibody are in the plasma)</Text>
