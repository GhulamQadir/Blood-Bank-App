...
function AGroup(){
    ...
    return(
        ...
        <View style={styles.aGroupView}>
            <Image style={styles.aGroupImg} source={{uri: 'https://i0.wp.com/www.newsgram.com/wp-content/uploads/2020/03/blood-group-2668685_1280.png'}} />
            <Text style={styles.aGroupText}>Group A can donate red blood cells to A's and B's. It has only the A antigen on red cells (and B antibody in the plasma)</Text>
